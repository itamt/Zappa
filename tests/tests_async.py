...
from zappa.non_blocking import AsyncException, LambdaAsyncResponse, SnsAsyncResponse
from zappa.non_blocking import import_and_get_task, \
                        get_func_task_path
...
class TestZappa(unittest.TestCase):
    ...
    def test_async_call_with_defaults(self):
        ...
        with mock.patch.dict('zappa.non_blocking.ASYNC_CLASSES',
